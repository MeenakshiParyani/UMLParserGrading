...
var imageAbsPath = path.resolve(__dirname + './../public/app/vivek/assets/images');
...
router.get('/parse', function(req, res) {
    ...
    var outputFilename = 'output' + timestamp + '.png';
    var outputFilenameWoExt = 'output' + timestamp;
    var outputFilepath = path.resolve(sourcePath + '/' + outputFilename);
    var child = exec('rm ' + path.resolve(imageAbsPath + '/' + outputFilename),
      setTimeout(function (error, stdout, stderr){
        console.log(stderr + ' ' + outputFilename);
        var parseCommand = 'java -jar ' + libPath + '/umlparser.jar class ' + sourcePath + ' ' + outputFilenameWoExt;
          console.log(parseCommand);
          exec(parseCommand,
          function (error, stdout, stderr){
            console.log(stderr);
            var fileCopyCommand = 'cp ' + outputFilepath + ' ' + path.resolve(imageAbsPath + '/' + outputFilename);
            console.log(fileCopyCommand);
            exec(fileCopyCommand,
            function (error, stdout, stderr){
