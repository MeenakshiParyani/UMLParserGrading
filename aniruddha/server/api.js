...
var imageAbsPath = path.resolve(__dirname + './../public/app/aniruddha/assets/images');
...
router.get('/parse', function(req, res) {
    ...
    var child = exec('rm ' + path.resolve(imageAbsPath + '/' + outputFilename),
      setTimeout(function (error, stdout, stderr){
        ...
        var parseCommand = 'java -jar ' + libPath + '/umlparser.jar ' + sourcePath + ' ' + outputFilenameWoExt;
